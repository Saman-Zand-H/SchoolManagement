...
window.addEventListener('load', function () {
    ...
    function initialiseState(reg) {
        ...
        if (!(reg.showNotification)) {
            ...
            subBtn = 'Subscribe to Push Messaging';
        ...
        if (Notification.permission === 'denied') {
            // Show a message and activate the button
            subBtn.innerHTML = '<i class="far fa-bell"></i>' + gettext('Subscribe to Push Messaging');
        ...
        if (!('PushManager' in window)) {
            // Show a message and activate the button
            subBtn.innerHTML = '<i class="far fa-bell"></i>' + 'Subscribe to Push Messaging';
            subBtn.disabled = false;
                    ...
                    postSubscribeObj('subscribe', subscription,
                        function (response) {
                            ...
                            if (response.status === 201) {
                                ...
                                subBtn.innerHTML = '<i class="far fa-bell"></i>' + gettext('Unsubscribe from Push Messaging');
                                subBtn.disabled = false;
                                isPushEnabled = true;
...
function showMessage(message) {
    ...
    if (messageBox) {
        messageBox.innerHTML = '<i class="far fa-bell"></i>' + message;
