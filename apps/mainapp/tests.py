...
class ClassTests(TestCase):
    def setUp(self):
        self.student_user = get_user_model().objects.create_user(
            "test_student", "s@test.com", "test student", "123456789S@", "S")
        self.teacher_user = get_user_model().objects.create_user(
            "test_teacher", "t@test.com", "test teacher", "123456789S@", "T")
        ...
        self.exam = Exam.objects.create(teacher=self.teacher,
...
class ExamTest(TestCase):
    def setUp(self):
        ...
        self.grade = Grade.objects.create(student=self.student,
                                          subject=self.subject,
                                          grade=19.25)
